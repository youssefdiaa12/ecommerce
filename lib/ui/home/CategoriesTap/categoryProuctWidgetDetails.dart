...
class categoryProuctWidgetDetails extends StatefulWidget {
  Product product;

  categoryProuctWidgetDetails(this.product, {super.key});

  @override
  State<categoryProuctWidgetDetails> createState() => _categoryProuctWidgetDetailsState();
}

class _categoryProuctWidgetDetailsState extends State<categoryProuctWidgetDetails> {
  @override
