...
class UpdateCarrtListResponse {
  ...
  num? numOfCartItems;
  Data? data;
UpdateCarrtListResponse copyWith({  String? status,
  num? numOfCartItems,
  Data? data,
}) => UpdateCarrtListResponse(  status: status ?? this.status,
