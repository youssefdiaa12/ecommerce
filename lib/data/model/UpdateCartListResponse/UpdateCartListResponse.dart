...
class UpdateCartListResponse {
  UpdateCartListResponse({
      this.status, 
      this.numOfCartItems, 
      this.data,});

  UpdateCartListResponse.fromJson(dynamic json) {
    status = json['status'];
  ...
  int? numOfCartItems;
  Data? data;
UpdateCartListResponse copyWith({  String? status,
  int? numOfCartItems,
  Data? data,
}) => UpdateCartListResponse(  status: status ?? this.status,
