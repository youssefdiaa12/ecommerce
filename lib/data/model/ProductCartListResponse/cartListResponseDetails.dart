...
class cartListResponseDetails {
  ...
  cartListResponseDetails.fromJson(dynamic json) {
    id = json['_id'];
  ...
  int? v;
  int? totalCartPrice;
cartListResponseDetails copyWith({  String? id,
  String? cartOwner,
  List<Products>? products,
  String? createdAt,
  String? updatedAt,
  int? v,
  int? totalCartPrice,
}) => cartListResponseDetails(  id: id ?? this.id,
