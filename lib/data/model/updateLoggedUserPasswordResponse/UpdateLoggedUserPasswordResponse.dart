...
class UpdateLoggedUserPasswordResponse {
  UpdateLoggedUserPasswordResponse({
      this.message, 
      this.user, 
      this.token,});

  UpdateLoggedUserPasswordResponse.fromJson(dynamic json) {
  ...
  User? user;
  String? token;
UpdateLoggedUserPasswordResponse copyWith({  String? message,
  User? user,
  String? token,
}) => UpdateLoggedUserPasswordResponse(  message: message ?? this.message,
  user: user ?? this.user,
